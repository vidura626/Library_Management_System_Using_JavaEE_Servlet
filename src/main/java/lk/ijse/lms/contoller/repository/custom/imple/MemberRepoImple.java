...
public class MemberRepoImple implements MemberRepo {
    @Override
    public void add(Member member, Session session) throws Exception {
        session.save(member);
    }

    @Override
    public void update(Member member, Session session) throws Exception {
        session.update(member);
    }

    @Override
    public Member search(String s, Session session) throws Exception {
    ...
    @Override
    public List<Member> getAll(Session session) throws Exception {
